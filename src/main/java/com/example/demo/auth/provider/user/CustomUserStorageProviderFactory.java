...
import static com.example.demo.auth.provider.user.CustomUserStorageProviderConstants.CONFIG_KEY_DB_PASSWORD;
import static com.example.demo.auth.provider.user.CustomUserStorageProviderConstants.CONFIG_KEY_DB_USERNAME;
import static com.example.demo.auth.provider.user.CustomUserStorageProviderConstants.CONFIG_KEY_JDBC_DRIVER;
import static com.example.demo.auth.provider.user.CustomUserStorageProviderConstants.CONFIG_KEY_JDBC_URL;
